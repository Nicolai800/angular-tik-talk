...
export class SettingsPageComponent {
  ...
  @ViewChild(AvatarUploadComponent) avatarAploader!: AvatarUploadComponent;
  ...
  onSave() {
    ...
    if (this.avatarAploader.avatar) {
      firstValueFrom(
        this.profileService.uploadAvatar(this.avatarAploader.avatar)
      );
    }
